...
contract QuestNFT is ERC721, Ownable, Pausable {
    ...
    // do you own X NFT
    function NFTOwnershipQuest(address NFTcontract) {
    ...
    function ERC20BalanceQuest(address ERC20contract, uint256 amount) {
        address playerAddress = msg.sender;
    ...
    function SignedMessageQuest(bytes32 _hashedMessage, uint8 _v, bytes32 _r, bytes32 _s) public pure returns (address) {
